...
type QueueMessage struct {
	...
	Envelope      *envelopepb.Envelope   `protobuf:"bytes,15,opt,name=Envelope,proto3" json:"Envelope,omitempty"`
...
func (x *QueueMessage) GetEnvelope() *envelopepb.Envelope {
	if x != nil {
		return x.Envelope
	}
	return nil
...
const file_github_com_dogmatiq_verity_persistence_boltpersistence_internal_pb_queue_proto_rawDesc = "" +
	"\n" +
	"Ngithub.com/dogmatiq/verity/persistence/boltpersistence/internal/pb/queue.proto\x12\x1cverity.persistence.boltdb.v1\x1a@github.com/dogmatiq/enginekit/protobuf/envelopepb/envelope.proto\"\xb3\x01\n" +
	"\fQueueMessage\x12\x1a\n" +
	"\brevision\x18\x01 \x01(\x04R\brevision\x12#\n" +
	"\rfailure_count\x18\x02 \x01(\x04R\ffailureCount\x12&\n" +
	"\x0fnext_attempt_at\x18\x03 \x01(\tR\rnextAttemptAt\x124\n" +
	"\bEnvelope\x18\x0f \x01(\v2\x18.dogma.protobuf.EnvelopeR\bEnvelopeJ\x04\b\x04\x10\x0fBDZBgithub.com/dogmatiq/verity/persistence/boltpersistence/internal/pbb\x06proto3"
...
var file_github_com_dogmatiq_verity_persistence_boltpersistence_internal_pb_queue_proto_depIdxs = []int32{
	1, // 0: verity.persistence.boltdb.v1.QueueMessage.Envelope:type_name -> dogma.protobuf.Envelope
